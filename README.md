...
| ![notes](https://raw.githubusercontent.com/ulsklyc/yuvomi/main/docs/icons/notes.png) | **Notes & Contacts** | Colored Markdown sticky notes that open in a rendered reader view (toggle to edit) plus a contact directory with CardDAV sync. |
