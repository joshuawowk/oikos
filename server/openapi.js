  ...
  return {
    ...
    '/api/v1/calendar': {
      ...
      post: op({
        ...
        tag: 'Calendar',
        stateChanging: true,
        description: 'Supports optional local file attachments via `attachment_name`, `attachment_mime`, `attachment_size`, and `attachment_data` (base64 data URL). Set `target_caldav_account_id` and `target_caldav_calendar_url` to push the event to a CalDAV calendar (omit or null for a local-only event).',
